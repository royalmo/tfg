...
que esisteix un \est{driver} per a \est{hid_accelerometer_3d}, pel que
...
\subsubsection{\est{Xrandr} i les sessions}
...
\begin{itemize}
    \item La primera és $DISPLAY
    \item La segona és $XAUTHORITY
    \item La tercera és XDG_RUNTIME_DIR=/run/user/1000
    Finalment, https://unix.stackexchange.com/questions/209746/how-to-resolve-no-protocol-specified-for-su-user
    xhost +
\end{itemize}
