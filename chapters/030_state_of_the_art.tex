...
\ref{sec:usb_versions}, s'acabarà utilitzant la versió \acro{usb2}. Per a
evitar fer molt extens aquest document, només es detallarà l'arquitectura
d'aquesta versió.

\subsubsection*{Baix nivell}
...
Per a poder dir que un producte ofereix connectivitat \acro{usb}, la empresa
