...
dispositiu, amb una intensitat de fins a \SI{500}{\milli\amperes}. Aquestes
...
és de \SI{3.3}{\volts}, encara que la tensió que proporciona el cable
d'alimentació sigui de \SI{5}{\volts}. Aquest detall serà molt important de cara
...
apartat es defineixen els tres tipus de 
% CONTINUE


\subsection{\est{\acro{Usb} Implementers Forum}}
...
primer dels casos val \SI{5000}{\dollar} anualment, mentre que el segon
val \SI{6000}{\dollar} d'entrada i \SI{3500}{\dollar} cada dos anys
