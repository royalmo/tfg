...
El punt de partida és els codis d'exemples del repositori del projecte \cite{VusbProjects}.
...
protocol \acro{usb}. Es disposa d'una freqüència de 16.5MHz i
\acro{usb2} funciona a 1kHz.
...
Així doncs, s'ha optat per a agafar el \acro{vid-pid} 0x16c0-0x09e8, que és la
...
al sensor d'aquest projecte, l'adreça és 0x68 \cite{MPU6050reg}. Després d'aquests 7 bits,
...
els registres 0x42:0x41 es podrà consultar el valor mesurat de temperatura
