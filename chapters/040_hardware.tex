...
\begin{itemize}
    ...
    condensador ceràmic de $10uF$ VERIFICAR!!, per a assegurar-se que la tensió
...
la memòria \est{flash} disponible. (CITE)
...
\est{i2c\_tiny\_usb} (CITE). Aquest projecte ha aconseguit dissenyar una placa
...
\begin{itemize}
    ...
    en el \est{kernel} de Linux, s'hauria de fer de zero per altres sistemes
    operatius.
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\textwidth]{images/kicad/gyro2_pcb.png}
