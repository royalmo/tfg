...
En el moment de provar la llibreria es va descobrir que, en funció dels
controladors de la targeta gràfica que hi hagi insta\l.lats a l'ordinador i de
les seves versions, l'ordre \ord|xrandr| causa un congelament de mig segon
aproximadament de totes les pantalles del sistema. Aquest error ja ha estat
reportat \cite{xrandrBug}, però no s'ha trobat cap solució específica. En el
cas personal, tant actualitzar la distribució d'Ubuntu (de 18.04 a 24.04) com
desinsta\l.lar els controladors gràfics de \acro{nvidia} ha arreglat el problema.
