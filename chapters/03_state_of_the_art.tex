...
recerca molt superficial, i es preten afirmar la certesa d'aquest esquema amb
els apartats que venen a continuació.
...
Es poden veure el llistat de classes i subclasses \acro{hid} a la documentació
oficial d'\acro{usb-if} \cite{HidDefinition}.
...
A part de \acro{v-usb} també hi ha altres llibreries, com \acro{lufa}, que també
implementen el protocol \acro{usb}. El problema d'aquestes és que utilitzen
...
possible de mostrar un fitxer \fitx{/dev/usbrawX} d'un dispositiu \acro{hid}
\cite{unbindingHid}.
