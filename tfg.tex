...
% Per a alinear coses dins de taules
\usepackage{booktabs}
\usepackage{array}

%%% AFEGITS PER ALGORITME TIKZ %%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Per a posar claudàtors que englobin coses grans
...
\begin{acknowledgments}
    ...
    Joan Martínez que, juntament amb el meu tutor, m'ha aconsellat durant el
    ...
    quotidià que, potser fins i tot sense saber-ho, han fet que aquests
...
\begin{resum}
    ...
    les diverses causes per la qual la gent es planteja tenir una pantalla
    d'ordinador en aquesta nova orientació. 
    ...
    ja existent, poden notificar a l'ordinador els canvis d'orientació. Tanmateix,
    ...
    d'acceleració i una connexió \acro{usb}, detecta l'orientació de la pantalla i
...
\begin{abstract}
    ...
    This project proposes a low-cost device that, using an accelerometer sensor and a
...
\include{chapters/04_hardware}
\include{chapters/05_firmware}
\include{chapters/06_software_linux}
\include{chapters/07_software_other}
\include{chapters/08_economical_aspects}
